...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const existingProfile = userDataManager.getUserProfile()

      // Create user profile with signup data, preserving existing data
      const userProfile = {
        ...existingProfile, // Preserve any existing profile data
        firstName: firstName,
        lastName: lastName,
        email: email,
        username: username,
        ...
        debt: existingProfile.debt || "",
        riskTolerance: existingProfile.riskTolerance || "",
        timeHorizon: existingProfile.timeHorizon || "",
        investmentExperience: existingProfile.investmentExperience || "",
        completedOnboarding: existingProfile.completedOnboarding || false,
        signedUp: true,
        signedIn: true,
        rememberMe: false,
      }
      ...
      const registrationResult = await userDataManager.registerUser(email, password, fullName)
      console.log("[v0] Registration result:", registrationResult)
      ...
      userDataManager.saveUserProfile(userProfile)

      console.log("[v0] Registration successful, user is now registered!")
