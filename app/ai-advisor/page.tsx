...
import { Send, Bot, User, Lightbulb, TrendingUp, PiggyBank, Target, AlertCircle, CheckCircle } from "lucide-react"
  ...
  const sendMessage = async (messageContent?: string) => {
    ...
    try {
      ...
      const errorMessage: Message = {
        role: "assistant",
        content:
          "I apologize, but I'm having trouble responding right now. Please try again in a moment, or feel free to explore the learning modules while I get back online!",
        timestamp: new Date(),
        source: "error",
      }
          ...
          <CardContent className="flex-1 flex flex-col p-0">
            ...
            <div className="p-4">
              ...
              <div className="mt-2 text-xs text-gray-500 text-center">
                This AI provides educational information, not professional financial advice.
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <h3 className="font-semibold mb-1">Personalized Advice</h3>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <h3 className="font-semibold mb-1">Investment Guidance</h3>
              <p className="text-sm text-gray-600">
                Learn about investment strategies suitable for your risk tolerance
              </p>
            </CardContent>
          </Card>
          <Card>
