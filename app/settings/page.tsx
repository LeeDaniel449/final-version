...
export default function SettingsPage() {
  ...
  useEffect(() => {
    ...
    const handleUserDataUpdate = () => {
      const updatedProfile = userDataManager.getUserProfile()
      setUserProfile(updatedProfile)
      setProfileImage(updatedProfile?.profileImage ?? null)
    }

    window.addEventListener("userDataUpdated", handleUserDataUpdate)
    window.addEventListener("userSignedIn", handleUserDataUpdate)
    window.addEventListener("userSignedUp", handleUserDataUpdate)

    return () => {
      window.removeEventListener("userDataUpdated", handleUserDataUpdate)
      window.removeEventListener("userSignedIn", handleUserDataUpdate)
      window.removeEventListener("userSignedUp", handleUserDataUpdate)
    }
  }, [])
