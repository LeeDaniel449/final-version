              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <div className="bg-blue-100 p-2 rounded font-mono text-sm flex items-center justify-between">
                    <span>NEXT_PUBLIC_ALPHA_VANTAGE_API_KEY=your_api_key_here</span>
                  </div>
                </div>
              </div>
            ) : (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      ...
                      <ul className="text-sm text-blue-700 space-y-1">
                        <li>• Make sure the environment variable name is exactly: NEXT_PUBLIC_ALPHA_VANTAGE_API_KEY</li>
